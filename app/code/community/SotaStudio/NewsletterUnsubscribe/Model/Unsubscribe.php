...
class SotaStudio_NewsletterUnsubscribe_Model_Unsubscribe extends Mage_Newsletter_Model_Subscriber
{
	/**
	...
	public function sendConfirmationSuccessEmail() {
		// do not send two E-Mails, maybe Magento will implement this line in method self::confirm($code)
